---
title: Crear contenido accesible (en conformidad con WCAG 2.0)
...
[Directrices 1.1 Alternativas de texto: Proporcione alternativas de texto para cualquier contenido no textual y así poder cambiarlo por otras formas según sea necesario, como letras grandes, braille, voz, símbolos o lenguaje más sencillo.](https://www.w3.org/TR/WCAG20/#text-equiv)
...
[Directrices 1.2 Medios basados en el tiempo: Proporcionar alternativas para los medios basados en el tiempo.](https://www.w3.org/TR/WCAG20/#text-equiv)
...
* **Texto subrayado**:
  ...
  >* &lt;i> para &lt;em>
  >
  >Aunque son iguales, &lt;strong> y &lt;em> are preferable as they are semantically correct html. Su equipo de desarrollo puede configurar el RTE para utilizar &lt;strong> y &lt;em> (instead of &lt;b> and &lt;i>) when developing your project instance.
...
[Directrices 1.4 Distinguible: Facilitar a los usuarios ver y oír el contenido, incluyendo la separación del primer plano del fondo.](https://www.w3.org/TR/WCAG20/#visual-audio-contrast)
...
[Principio 2: operable. Los componentes y la navegación de la interfaz de usuario deben ser operables.](https://www.w3.org/TR/WCAG20/#operable)
...
* Utilice las tecnologías adecuadas para mostrar el contenido parpadeante que el explorador puede desactivar. Por ejemplo, archivos de Formato de intercambio de gráficos (GIF) o Gráficos de red portátiles animados (APNG).
...
[Principio 3: Comprensible. La información y el funcionamiento de la interfaz de usuario deben ser comprensibles.](https://www.w3.org/TR/WCAG20/#understandable)
