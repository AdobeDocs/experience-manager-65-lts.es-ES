...
+ Recursos {#assets}
   ...
   + Dynamic Media{#dynamic}
      ...
      + [Configuración de una cuenta de alias de compañía de Dynamic Media](/help/assets/dm-alias-account.md)
...
+ Formularios {#forms}
   ...
   + Forms Designer {#use-forms-designer}
      ...
      + Prácticas recomendadas de accesibilidad {#accessibility-best-practices}
         ...
         + [Enlaces útiles](/help/forms/using/useful-links-accessibility-forms-designer.md)
   ...
   + Informes de transacciones {#transaction-reports}
      ...
      + Informes de transacciones para AEM Forms en OSGi {#transaction-reports-osgi}
         ...
         + [Registrar una transacción para API de componente personalizado](/help/forms/using/record-transaction-custom-component-jee.md)
   + Ayuda del administrador para AEM Forms en JEE {#administrator-help}
      ...
      + Conectarse a un sistema de administración de contenido {#connect-content-management-system}
         ...
         + [Configuración del conector para el administrador de contenido de IBM®](/help/forms/using/admin-help/configuring-connector-ibm-content-manager.md)
      ...
      + Configuración de Forms Workflow{#configure-forms-workflow}
         ...
         + [Información general de Forms Workflow](/help/forms/using/admin-help/overview-9.md)
      ...
      + Mantenimiento del servidor de aplicaciones {#manage-application-server}
         ...
         + [Iniciar y detener WebSphere® Application Server](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + Copia de seguridad y recuperación de AEM Forms {#aem-forms-backup-recovery}
         + [Copia de seguridad y recuperación del repositorio de EMC Documentum®](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
   ...
   + Referencia para desarrolladores {#developer-reference}
      ...
      + Programar con AEM Forms en JEE {#programming-aem-forms-jee}
         ...
         + Realización de operaciones de servicio mediante API {#performing-service-operations-using-apis}
            ...
            + [Procesar formularios con derechos habilitados](/help/forms/developing/rendering-rights-enabled-forms.md)
            ...
            + [Uso de Forms con códigos de barras](/help/forms/developing/barcoded-forms.md)
...
+ Implementación {#implementing}
   ...
   + Implementación {#deploying}
      ...
      + Actualización a AEM 6.5 LTS {#upgrading}
         ...
         + [Actualización de formularios de búsqueda personalizados](/help/sites-deploying/upgrading-custom-search-forms.md)
