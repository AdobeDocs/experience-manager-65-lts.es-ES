...
Para obtener una lista de los sistemas operativos compatibles con AEM 6, consulte la [página de requisitos técnicos](/help/sites-deploying/technical-requirements.md).
