...
| 1 | [Creación para AEM Headless: introducción](introduction.md) | Introducción a las funciones sin encabezado de Adobe Experience Manager y cómo crear contenido para el proyecto. |
...
Ya está listo para empezar su recorrido de Adobe sin encabezado. Le recomendamos que continúe con la siguiente parte del recorrido y lea el artículo [Creación para AEM Headless: introducción.](introduction.md)
