...
* AEM 6.5.17.0 a AEM Forms 6.5 LTS
* AEM 6.5.18.0 a AEM Forms 6.5 LTS
* AEM 6.5.19.0 a AEM Forms 6.5 LTS
* AEM 6.5.20.0 a AEM Forms 6.5 LTS
* AEM 6.5.21.0 a AEM Forms 6.5 LTS
* AEM 6.5.22.0 a AEM Forms 6.5 LTS
* AEM 6.5.23.0 a AEM Forms 6.5 LTS

### AEM Forms LTS en JEE

El diagrama siguiente muestra las rutas de actualización disponibles para AEM Forms LTS en JEE:

![Actualización de JEE 6.5](do-not-localize/jee-upgrade-6-5.svg)

Puede realizar una actualización directa desde:

* AEM 6.5.23.0 Forms en JEE

#### ¿Cómo actualizo Adobe Experience Manager Forms (AEM Forms) en JEE? {#how-do-i-upgrade-aem-forms-on-jee}

Para obtener PDF de actualización paso a paso (llave en mano, un solo servidor y clúster de JBoss), consulte [Flujo de trabajo de instalación y actualización para AEM Forms en JEE](/help/forms/using/aem-forms-jee-installation-upgrade-documentation.md).
