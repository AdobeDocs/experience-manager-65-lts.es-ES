...
description: En este tema se explica cómo editar el Compositor de recursos con configuraciones específicas de la solución.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>La anchura mínima que se aplicará en el campo viñeta / número al utilizar listas numeradas separadas de números romanos.</td>
   <td>8,0 mm</td>
   <td>Cualquier número</td>
  </tr>
  <tr>
   <td><p>Anchura mínima de los números romanos</p> </td>
   <td><p>La anchura mínima que se aplicará en el campo viñeta / número al utilizar números romanos.</p> </td>
   <td><p>12,7 mm</p> </td>
   <td><p>Cualquier número</p> </td>
  </tr>
  <tr>
   <td>Tipo de representación</td>
   <td>El tipo de representación que utiliza la aplicación para obtener la vista previa de la carta. </td>
  ...
  <tr>
   ...
   <td><p>Habilita el resaltado de PDF en la aplicación.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de resaltado de destino</p> </td>
   <td><p>Tipo de resaltado de destino en la aplicación.</p> </td>
   <td><p>border</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Color de resaltado de destino</p> </td>
   <td><p>Color de resaltado de destino en la aplicación.</p> </td>
   <td><p>90;155;245</p> </td>
   <td><p>Cualquier color RGB en el formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de resaltado de contenido</p> </td>
   <td><p>Tipo de resaltado de contenido en la aplicación.</p> </td>
   <td><p>Relleno</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Color de resaltado de contenido</p> </td>
   <td><p>Color de resaltado de contenido en la aplicación.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Cualquier color RGB en el formato R;G;B</p> </td>
  </tr>
  <tr>
   <td><p>Tipo de resaltado de campo</p> </td>
   <td><p>Tipo de resaltado de campo en la aplicación.</p> </td>
   <td><p>fill</p> </td>
   <td><p>border / fill / none</p> </td>
  </tr>
  <tr>
   <td><p>Color de resaltado de campo</p> </td>
   <td><p>Color de resaltado de campo en la aplicación.</p> </td>
   <td><p>210;225;245</p> </td>
   <td><p>Cualquier color RGB en el formato R;G;B</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Nombre del parámetro para el documento de PDF en el proceso posterior.</p> </td>
   <td><p>inPDFDoc</p> </td>
  ...
  <tr>
   ...
   <td><p>Tipo de envío de PDF (tipo de PDF generado al realizar el envío desde la aplicación).</p> </td>
  ...
  <tr>
   ...
   <td><p>Controla si se deben utilizar formatos de edición de datos configurados y de visualización de datos.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Formatos de visualización de datos</p> </td>
   <td><p>Especifica un formato de visualización de datos específico de la configuración regional.</p> </td>
  ...
  <tr>
   ...
   <td><p>Habilitar/deshabilitar la funcionalidad de cartas (aplicable solo para el servidor de publicación).</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Habilitar auditoría</p> </td>
   <td><p>Habilitar/deshabilitar la funcionalidad de auditoría. Si es false, los registros de auditoría de todas las acciones están deshabilitados.</p> </td>
   <td><p>false</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><p>Especifique el Número máximo de cartas que se guardarán en la caché.</p> <p>Si se cambia este valor, se limpiará la caché de <code>in-memory</code>.</p> </td>
   <td><p>100</p> </td>
   <td><p>Cualquier valor numérico</p> </td>
  </tr>
  <tr>
   <td><p>Habilitar memoria caché de Cartas</p> </td>
   <td><p>Habilitar/deshabilitar la memoria caché de cartas.</p> <p>Si se cambia este valor, se limpiará la caché de <code>in-memory </code>.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Solicitud de elementos de datos</p> </td>
   <td><p>Mantiene el orden de los elementos de datos en la interfaz según su secuencia en Cartas.</p> </td>
   <td><p>true</p> </td>
   <td><p>true / false</p> </td>
  </tr>
  <tr>
   <td><p>Compatibilidad de Recargas</p> </td>
   <td><p>Habilitar/deshabilitar la compatibilidad de recarga en cartas representadas en el lado del servidor.</p> <p>Deshabilitar mejora el rendimiento del procesamiento de cartas.</p> </td>
   <td><p>false</p> </td>
  ...
  <tr>
   ...
   <td>Ubicación de la carpeta del sistema de archivos para la depuración. Si el directorio no <code>exists</code>, no se generan volcados de depuración.</td>
