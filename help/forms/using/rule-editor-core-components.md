...
* Un botón de opción, **[!UICONTROL ¿Es usted cliente de Geometrixx?]**, que proporciona las opciones [!UICONTROL Sí] y [!UICONTROL No]. El valor de Yes es **0** y No es **1**.
