...
Inicio rápido (SOAP) de la API de Java™ está disponible para la API del servicio de copia de seguridad y restauración.
...
## Inicio rápido (modo SOAP): Introducción al modo de copia de seguridad mediante la API de Java™ {#quick-start-soap-mode-entering-backup-mode-using-the-java-api}
