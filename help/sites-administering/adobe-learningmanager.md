...
Para obtener más información, consulte el paquete del [sitio de referencia de Adobe Learning Manager (sitio de referencia de ALM) para AEM Sites](https://experienceleague.adobe.com/es/docs/learning-manager/using/integration/aem-sites/adobe-learning-manager-integration-aem).
