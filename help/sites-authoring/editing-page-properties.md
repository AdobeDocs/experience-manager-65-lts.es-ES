...
Cuando se configuren las horas de activación/desactivación, verá iconos e información adicionales relacionados con las horas de activación/desactivación en las [vistas de lista y de tarjeta de la consola Sites](/help/sites-authoring/basic-handling.md#views), así como en la [vista de cronología del panel lateral de la consola.](/help/sites-authoring/basic-handling.md#timeline)
