...
* Se ha agregado una petición de datos en modo rápido del Administrador de configuración (LCM) para las credenciales del administrador de AEM durante la configuración, reemplazando las credenciales predeterminadas integradas. Esta mejora está disponible a través de la revisión JEE del SP2 de 6.5 LTS. (FORMS-26704)
...
**Los siguientes problemas se han corregido en la revisión JEE del paquete de servicio 2 de AEM Forms 6.5 LTS (versión 6.6.0-0006). Para aplicarlos, [descargue e instale la revisión](/help/forms/using/adobe-experience-manager-forms-65-lts-hotfixes.md).**

* Después de actualizar Apache Shiro a la versión 2.1.0, AEM Forms en JEE no pudo arrancar con un `NoClassDefFoundError` para el administrador de seguridad de Shiro. El arranque ahora se completa correctamente. (FORMS-26818)
* Error de AEM Forms en JEE con el error &quot;no se encontró la clase&quot; para `org.owasp.esapi.reference.JavaLogFactory`. La clase que falta se ha resuelto. (FORMS-26819)
* Después de actualizar a AEM Forms 6.5 LTS, se eliminaron los extremos de TaskManager. Los puntos finales ahora se conservan. (FORMS-26584, FORMS-26589)
* En JEE, el paso MergeEars del Administrador de configuración produjo un error de declaración DOCTYPE (`ALC-LCM-010-200`) debido al generador de XML seguro. MergeEars ahora se completa. (FORMS-26569)
* Faltaban registros de nivel de aplicación en las implementaciones de IBM® WebSphere® Liberty. Ahora se restaura el registro en el nivel de aplicación. (FORMS-25063)
* En JBoss®, el correo electrónico falló con &quot;IMAPProvider no es un subtipo&quot;. El correo electrónico ahora funciona en JBoss®. (FORMS-24892)
* En WebSphere® Liberty Profile (WLP), el correo electrónico fallaba con &quot;No se pudo convertir el socket a TLS&quot;. El correo electrónico a través de TLS ahora funciona en WLP. (FORMS-24692)
* Se ha actualizado la biblioteca Gibson a la versión 6.0.29665850. (FORMS-26688)
* Mejoras en la validación de aserciones SAML. (FORMS-25222)
* Apache Log4j actualizada a la versión 2.25.5. (FORMS-26733, FORMS-26734)
* Este hotfix también incluye correcciones de seguridad.
