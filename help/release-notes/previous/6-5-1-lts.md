...
* Oracle Java™ 17/21 (64 bits) (Para obtener más información, consulte la sección [Compatibilidad con Java](#java-support).
...
### Corrupción del repositorio durante la compactación en línea después de la compactación sin conexión (GRANITE-65146)

Los usuarios experimentaban daños en el repositorio durante la compactación en línea si la compactación sin conexión se había ejecutado anteriormente en el repositorio JCR. Se puede producir un `SegmentNotFoundException` (SNFE) en este escenario. Puede provocar daños en el repositorio.
...
>[!NOTE]
>
> Para cualquier operación de oak-run, use el [jar oak-run 1.78.1-B006](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (enlazado arriba).
