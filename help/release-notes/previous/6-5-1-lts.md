...
source-git-commit: ff5cd8a0182c91559abfb32dc3eef4133048477e
workflow-type: tm+mt
...
* **FORMS-24688:** Al configurar JBoss EAP 8.0 (AEM Forms 6.5.1 LTS) en Linux, los scripts modificados en Windows pueden contener extremos de línea CRLF, lo que provoca que /bin/sh^M: intérprete incorrecto o $&#39;\r&#39;: comando no encontrado. Convierta los archivos .sh afectados al formato Unix (LF) utilizando dos2unix (por ejemplo, busque . -type f -name &quot;*.sh&quot; -exec dos2unix {} +) para resolver el problema.
