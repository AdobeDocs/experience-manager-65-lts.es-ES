...
**Entorno**
Se aplica a: clientes de AEM 6.5 LTS (local) que instalan el Service Pack 1 (SP1). SP1 se suministra como un archivo JAR de inicio rápido.

**Por qué es importante**
SP1 para AEM 6.5 LTS se envía como un JAR de inicio rápido en lugar de como un ZIP para instalarlo a través del Administrador de paquetes. Los clientes locales se actualizan reemplazando el JAR de Quickstart, descomprimiéndolo y reiniciándolo. Este método es coherente con el procedimiento de actualización in situ de Adobe.
...
Los usuarios experimentaban daños en el repositorio durante la compactación en línea si esta se ejecutaba anteriormente en el repositorio JCR. Se puede producir un `SegmentNotFoundException` (SNFE) en este escenario. Puede provocar daños en el repositorio.
...
Planifique el tiempo de inactividad de una instancia al aplicarla. Para la compactación sin conexión, use el [JAR de ejecución de Oak](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) correspondiente, también disponible en Distribución de software.

>[!NOTE]
>
> Para cualquier operación ejecutada por Oak, use el [Jar de Oak-run 1.78.1-B006](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq660/hotfixes/oak-run-1.78.1-B006.jar) (enlazado arriba).
