...
* Se ha añadido compatibilidad con Hcaptcha y Turnstile para Formularios adaptables basado en componentes de base. (FORMS-16562)
* Los usuarios experimentaron problemas de superposición de iconos en el cuadro de diálogo Crear configuración de hCaptcha. Al rellenar los campos obligatorios, el icono de información se solapaba con el icono de error, lo que provocaba confusión durante la configuración. (FORMS-16916)
...
* Los usuarios experimentaron cadenas no localizadas en el proceso de Formularios > Crear carpeta de inspección > Proceso de creación de carpeta de inspección. Al crear una carpeta inspeccionada, no se encontraron cadenas como “Creación de la carpeta inspeccionada” y “Carpeta de inspección creada correctamente”, lo que afectó a la experiencia de la interfaz de usuario. (FORMS-15234)
