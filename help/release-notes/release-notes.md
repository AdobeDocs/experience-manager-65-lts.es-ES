...
Ya está disponible AEM 6.5 Forms LTS en JEE. Para obtener más información sobre los entornos admitidos, consulte el documento [Plataforma admitida](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms): Combinaciones. Los vínculos del instalador están disponibles en la página [Versiones de AEM Forms](https://experienceleague.adobe.com/es/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases).
...
* Los usuarios en entornos Linux pueden encontrar errores en los scripts del instalador o del Administrador de configuración (LCM) debido a finales de línea de estilo Windows. Convierta todos los archivos .sh utilizando dos2unix antes de ejecutar el instalador o LCM para evitar errores de ejecución.
