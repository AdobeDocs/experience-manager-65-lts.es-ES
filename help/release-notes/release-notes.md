...
* Para obtener instrucciones detalladas sobre la actualización, consulte la [Guía de actualización de AEM Forms 6.5 LTS SP1 en JEE](https://experienceleague.adobe.com/en/docs/experience-manager-65-lts/content/forms/upgrade-aem-forms/upgrade)
