...
---
# Contribución a la documentación de Adobe Experience Manager 6.5 LTS

Gracias por contribuir con la documentación de Adobe Experience Manager 6.5 LTS. El equipo de documentación agradece las contribuciones de contenido de toda la comunidad de lectores y de otros empleados de Adobe.
...
Aunque cualquier contribución es bienvenida para mejorar la documentación de AEM, asegúrese de que las contribuciones se ajusten a determinadas directrices y normas, siempre que sea posible. Consulte las [Directrices para contribuir a la documentación de AEM](guidelines.md) para obtener más información.
